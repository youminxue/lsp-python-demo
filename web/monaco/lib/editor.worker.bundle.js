...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__position_js__ = __webpack_require__(9);
/*---------------------------------------------------------------------------------------------
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__promise_polyfill_polyfill_js__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_cancellation_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_event_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_common_keyCodes_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_uri_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_range_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_selection_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__core_token_js__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__standaloneEnums_js__ = __webpack_require__(102);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function createMonacoBaseAPI() {
    return {
        editor: undefined,
        languages: undefined,
        CancellationTokenSource: __WEBPACK_IMPORTED_MODULE_1__base_common_cancellation_js__["b" /* CancellationTokenSource */],
        Emitter: __WEBPACK_IMPORTED_MODULE_2__base_common_event_js__["a" /* Emitter */],
        KeyCode: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums_js__["o" /* KeyCode */],
        KeyMod: KeyMod,
        ...
        SelectionDirection: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums_js__["z" /* SelectionDirection */],
        MarkerSeverity: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums_js__["p" /* MarkerSeverity */],
        MarkerTag: __WEBPACK_IMPORTED_MODULE_9__standaloneEnums_js__["q" /* MarkerTag */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__types_js__ = __webpack_require__(20);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function logOnceWebWorkerWarning(err) {
    if (!__WEBPACK_IMPORTED_MODULE_2__platform_js__["g" /* isWeb */]) {
        // running tests
        return;
    }
...
var SimpleWorkerClient = /** @class */ (function (_super) {
    ...
    function SimpleWorkerClient(workerFactory, moduleId, host) {
        ...
        var hostMethods = __WEBPACK_IMPORTED_MODULE_3__types_js__["c" /* getAllMethodNames */](host);
        ...
        _this._lazyProxy = new Promise(function (resolve, reject) {
            ...
            _this._onModuleLoaded.then(function (availableMethods) {
                resolve(__WEBPACK_IMPORTED_MODULE_3__types_js__["b" /* createProxyObject */](availableMethods, proxyMethodRequest));
            }, function (e) {
                reject(e);
...
var SimpleWorkerServer = /** @class */ (function () {
    ...
    SimpleWorkerServer.prototype.initialize = function (workerId, loaderConfig, moduleId, hostMethods) {
        ...
        var hostProxy = __WEBPACK_IMPORTED_MODULE_3__types_js__["b" /* createProxyObject */](hostMethods, proxyMethodRequest);
        if (this._requestHandlerFactory) {
            // static request handler
            this._requestHandler = this._requestHandlerFactory(hostProxy);
            return Promise.resolve(__WEBPACK_IMPORTED_MODULE_3__types_js__["c" /* getAllMethodNames */](this._requestHandler));
        }
        if (loaderConfig) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            self.require([moduleId], function (module) {
                ...
                resolve(__WEBPACK_IMPORTED_MODULE_3__types_js__["c" /* getAllMethodNames */](_this._requestHandler));
            }, reject);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_uint_js__ = __webpack_require__(106);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(57), __webpack_require__(58)))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(121).setImmediate, __webpack_require__(58)))
...
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_arrays_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_diff_diff_js__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_common_iterator_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_common_platform_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_uri_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__core_range_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__diff_diffComputer_js__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__model_mirrorTextModel_js__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_wordHelper_js__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__modes_linkComputer_js__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__modes_supports_inplaceReplaceSupport_js__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__standalone_standaloneBase_js__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__base_common_types_js__ = __webpack_require__(20);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    MirrorModel.prototype.createWordIterator = function (wordDefinition) {
        ...
        var next = function () {
            if (wordRangesIdx < wordRanges.length) {
                ...
                return __WEBPACK_IMPORTED_MODULE_2__base_common_iterator_js__["c" /* FIN */];
            }
            else {
...
var EditorSimpleWorker = /** @class */ (function () {
    ...
    EditorSimpleWorker.prototype.computeMoreMinimalEdits = function (modelUrl, edits) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                result = [];
                lastEol = undefined;
                edits = Object(__WEBPACK_IMPORTED_MODULE_0__base_common_arrays_js__["r" /* mergeSort */])(edits, function (a, b) {
                    if (a.range && b.range) {
    ...
    EditorSimpleWorker.prototype.loadForeignModule = function (moduleId, createData, foreignHostMethods) {
        ...
        var foreignHost = __WEBPACK_IMPORTED_MODULE_13__base_common_types_js__["b" /* createProxyObject */](foreignHostMethods, proxyMethodRequest);
        var ctx = {
            host: foreignHost,
        ...
        if (this._foreignModuleFactory) {
            ...
            return Promise.resolve(__WEBPACK_IMPORTED_MODULE_13__base_common_types_js__["c" /* getAllMethodNames */](this._foreignModule));
        }
        // ESM-comment-begin
...
if (typeof importScripts === 'function') {
    ...
    __WEBPACK_IMPORTED_MODULE_3__base_common_platform_js__["b" /* globals */].monaco = Object(__WEBPACK_IMPORTED_MODULE_12__standalone_standaloneBase_js__["a" /* createMonacoBaseAPI */])();
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_diff_diff_js__ = __webpack_require__(92);
...
function getFirstNonBlankColumn(txt, defaultValue) {
    var r = __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__["q" /* firstNonWhitespaceIndex */](txt);
    if (r === -1) {
        return defaultValue;
    }
    return r + 1;
...
function getLastNonBlankColumn(txt, defaultValue) {
    var r = __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__["D" /* lastNonWhitespaceIndex */](txt);
    if (r === -1) {
        return defaultValue;
    }
    return r + 2;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_position_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewModel_prefixSumComputer_js__ = __webpack_require__(124);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_characterClassifier_js__ = __webpack_require__(71);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functional_js__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lifecycle_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__linkedList_js__ = __webpack_require__(68);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_js__ = __webpack_require__(13);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iterator_js__ = __webpack_require__(47);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
        ...
        return {
            next: function () {
                if (node === Node.Undefined) {
                    return __WEBPACK_IMPORTED_MODULE_0__iterator_js__["c" /* FIN */];
                }
                if (!element) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_worker_simpleWorker_js__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_services_editorSimpleWorker_js__ = __webpack_require__(158);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function initialize(foreignModule) {
    ...
    initialized = true;
    var simpleWorker = new __WEBPACK_IMPORTED_MODULE_0__base_common_worker_simpleWorker_js__["b" /* SimpleWorkerServer */](function (msg) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__diffChange_js__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hash_js__ = __webpack_require__(105);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    LcsDiff._getElements = function (sequence) {
        ...
        if (LcsDiff._isStringArray(elements)) {
            ...
            for (var i = 0, len = elements.length; i < len; i++) {
                hashes[i] = Object(__WEBPACK_IMPORTED_MODULE_1__hash_js__["b" /* stringHash */])(elements[i], 0);
            }
